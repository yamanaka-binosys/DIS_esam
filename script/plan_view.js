...
//			var url = base_url.concat("index.php/plan/action_delete");
//			$.post(url,{'dbname':dbname_val,'jyohonum':jyohonum_val,'edbn':edbn_val},function(data, status){},"html" );

			var sendUrl = base_url.concat("index.php/plan/action_delete");
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			xmlHttp.open("POST",sendUrl);
			xmlHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
			xmlHttp.send('dbname='+dbname_val+'&jyohonum='+jyohonum_val+'&edbn='+edbn_val);
		}
