...
class Sgmtb080 extends CI_Model {
...
//		$sql = "SELECT COUNT(distinct itemnm) as item_cnt FROM sgmtb080 WHERE dbnrinm = ?";
	 ...
	 * @return	boolean $res = TRUE = 成功:FALSE = 失敗
	 */
	function get_project_all_cnt()
	{
		log_message('debug',"========== get_project_all_cnt start ==========");
		// 初期化
		$res = NULL;
		// sql文作成
		$sql = "SELECT COUNT(dbnricd) AS all_cnt
				FROM SGMTB080;";
		...
		log_message('debug',"========== get_project_all_cnt end ==========");
		return $res;
	}
