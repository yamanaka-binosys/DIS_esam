...
class Project_possession extends MY_Controller {
  function index($conf_name = MY_PROJECT_POSSESSION)
  {
    try
    {
      log_message('debug',"========== project_possession index start ==========");
      ...
      if( isset($aitesk) ) {
        ...
        if(isset($aitesk[0])) $data["aiteskcd"] = $aitesk[0];	//相手先コード
        if(isset($aitesk[1])) $data["aitesk_name"] = $aitesk[1];	//相手先名(販売店名)
      }
      ...
      log_message('debug',"========== project_possession index end ==========");
    }catch(Exception $e){
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-index'));
    //$this->error_view($e);
    }
  }
   ...
   */
  function search($conf_name = MY_PROJECT_POSSESSION)
  {
  	try
  	{
  		log_message('debug',"========== project_possession index start ==========");
  		...
  		// エラー処理
  		$this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-search'));
  		//$this->error_view($e);
  	}
  }
  ...
  * @param
  */
  function register($conf_name = MY_PROJECT_POSSESSION)
  {
    try
    {
      log_message('debug',"========== project_possession register start ==========");
      $data = $this->init($conf_name); // ヘッダデータ等初期情報取得
      ...
      // Main表示情報取得
      $this->_display($data); // 画面表示処理
      log_message('debug',"========== project_possession register end ==========");
    }catch(Exception $e){
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-register'));
      //$this->error_view($e);
    }
  }
   ...
   */
  function show_target_list($conf_name = MY_PROJECT_POSSESSION)
  {
    try
    {
      log_message('debug',"========== project_possession index start ==========");
      ...
      $data["view_aitesk_name"] = $_GET['aitesk_name'];
      $data["view_aiteskcd"] = $_GET['aiteskcd'];
      ...
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-show_target_list'));
      //$this->error_view($e);
    }
  }
  ...
  function init($conf_name)
  {
    try
    {
      ...
      $data['form']        = "/project_possession/".$common_data['form'];  // フォームアクション
      ...
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-init'));
      //$this->error_view($e);
    }
  }
   ...
   */
  function ajax_select_item_list($conf_name = MY_PROJECT_POSSESSION)
  {
    try
    {
      log_message('debug',"========== project_possession ajax_select_item_list start ==========");
      $data = $this->init($conf_name); // ヘッダデータ等初期情報取得
      ...
      log_message('debug',"========== project_possession ajax_select_item_list end ==========");
    }catch(Exception $e){
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-ajax_select_item_list'));
      //$this->error_view($e);
    }
  }
  ...
  * (AJAX)企画アイテム表示 追加
  */
  function ajax_add_table_data($conf_name = MY_PROJECT_POSSESSION)
  {
    try
    {
      log_message('debug',"========== project_possession ajax_add_table_data start ==========");
      $data = $this->init($conf_name); // ヘッダデータ等初期情報取得
      ...
      log_message('debug',"========== project_possession ajax_add_table_data end ==========");
    }catch(Exception $e){
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-ajax_add_table_data'));
      //$this->error_view($e);
    }
  }
  ...
  private function _display($data)
  {
    try
    {
      ...
      $data['main']   = $this->load->view(MY_VIEW_PROJECT_POSSESSION, $data, TRUE);
      ...
      $this->load->view(MY_VIEW_PROJECT_POSSESSION, $data);
    }catch(Exception $e){
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-display'));
      //			$this->error_view($e);
    }
  }
  ...
  private function _validate_check()
  {
    try
    {
      ...
      // エラー処理
      $this->load->view('/parts/error/error.php',array('errcode' => 'project_possession-validation'));
