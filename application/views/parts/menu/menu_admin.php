...
<br>
<ul class="parent">
<li><a href="javascript:top_admin('<?php echo $base_url ?>','<?php echo SHOW_TOP_ADMIN ?>')">トップ</a></li>
...
<li><a href="javascript:message('<?php echo $base_url ?>','<?php echo SHOW_MESSAGE ?>')">メッセージ</a></li>
...
<ul class="sub">
<li><a href="javascript:user('<?php echo $base_url ?>','<?php echo SHOW_USER ?>')">ユーザー</a></li>
<li><a href="javascript:project_item('<?php echo $base_url ?>','<?php echo SHOW_PROJECT_ITEM ?>')">企画情報</a></li>
<li><a href="javascript:division('menu_division')">区分設定</a>
<div id="menu_division" style="display:none">
<ul class="sub">
<li><a href="javascript:division_add('<?php echo $base_url ?>','<?php echo SHOW_DIVISION ?>')">∟登録</a></li>
<li><a href="javascript:division_update('<?php echo $base_url ?>','<?php echo SHOW_DIVISION_SU ?>')">∟変更</a></li>
<li><a href="javascript:division_delete('<?php echo $base_url ?>','<?php echo SHOW_DIVISION_SD ?>')">∟削除</a></li>
</div>
</li>
