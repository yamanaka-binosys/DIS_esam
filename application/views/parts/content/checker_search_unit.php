...
<img src="<?php echo $base_url; ?>images/search_unit.gif" style="text-align:center;margin-left:80px;" alt=""/>
</td>
...
<form action="<?php echo $base_url; ?>index.php/checker_search_unit/index" name="set" method="POST">
<input type="button" id="set_btn" name="set_btn" onclick="setSubmit()" style="margin-left:70px;" value=" 決定 ">
...
<input type="hidden" value="unit" id="checker" name="checker">
</form>
</div>
</div>
