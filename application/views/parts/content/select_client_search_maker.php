...
$shop_type = $list_table['init_data']['select_s_type'];
...
<img src="<?php echo $base_url ?>images/search_shop.gif" alt=""/>
</td>
...
function set(){
	var form = $('form');  //contenのformを指定
 	
		if(document.getElementById('i_shop').checked == true){
			if(!document.getElementById('shopname').value){
				document.getElementById('errmsg').innerText='';
				document.getElementById('errmsg').innerText='店舗（一般店）を入力してください';
				return;
			}
		}
		...
		if(!window.parent.opener || window.parent.opener.closed){
			...
			if(document.getElementById('i_shop') != null){
				if(document.getElementById('i_shop').checked == true){
					if(document.getElementById('shopname').value){
					
					//document.getElementById('aiteskcd_<?php echo $count; ?>').value
						var aitesk = 'XXXXXXXX|' + document.getElementById('shopname').value;
						if(document.getElementById('shopname').value){
		...
		<div id="change_position" style="display:none"></div>
			...
			<table>
				...
				<tr>
					<td>
					    <input type="radio" name="shop_type" value="shop" class="radio_box_check" id="i_shop" title="店舗（一般店）" <?php echo (isset($shop_type) AND $shop_type === "shop") ? "checked" : ""; ?>>店舗（一般店）
					    <input type="text" name="shop_name" class="radio_box_value" id="shopname" title="店舗（一般店）" value="<?php echo (isset($_POST['shop_name'])) ? $_POST['shop_name'] : ""; ?>"><br>
					    <input type="radio" name="shop_type" value="maker" <?php echo (isset($shop_type) AND $shop_type === "maker") ? "checked" : ""; ?>>店舗（メーカー商談先）
					</td>
				</tr>
			</table>
		    <br>
			...
			<table class="search_list_box">
				...
				<tr>
					...
					<td align="right" >
						<select name="honbucd" class="search_list" id="daibunrui_list" onChange="reload_dropdown_maker('<?php echo $base_url; ?>');">
				...
				<tr>
					...
					<td align="right">
						<select name="bucd"  class="search_list" id="bu_list" onChange="reload_dropdown_maker_unit('<?php echo $base_url; ?>');">
							<option value="XXXXX">--選択してください--</option>
				...
				<tr>
					...
					<td align="right">
						<select name="kacd" class="search_list" id="unit_list" onChange="reload_dropdown_maker_user('<?php echo $base_url; ?>');">
							<option value="XXXXX">--選択してください--</option>
				...
				<tr>
					<td class="list_name">店舗名称</td>
					<td align="right"><input type="text" class="search_list" name="aitesknm" value="<?php echo (isset($_POST['aitesknm'])) ? $_POST['aitesknm']: "";?>"></td>
				</tr>
