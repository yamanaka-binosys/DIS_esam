...
<textarea style="height:100px; width:600px; margin-left:0px" name="sdn_niyo_<?php echo $count; ?>" readonly="readonly"><?php echo isset($result['sdn_niyo']) ? $result['sdn_niyo'] : ''?></textarea>
</td>
</tr>
