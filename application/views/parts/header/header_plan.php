...
<td >
<input type="button" style="width: 50px;" class="input" name="back_calendar" id="back_calendar" size="1" value="戻る" onclick="submit_back_plan_calendar('<?php echo $base_url; ?>');">    
</td>
</tr>
<tr>
