...
<td></td>
<td>
<input type="hidden" name="aiteskcd_<?php echo $count; ?>" id="aiteskcd_<?php echo $count; ?>" value="<?php echo isset($result['aiteskcd']) ? $result['aiteskcd'] : ''?>"  class="required" title="代理店本支店名">
...
<td></td>
<td>
<input type="text" style="width: 200px;" style="width:290px;" maxlength="256" name="doukounm01_<?php echo $count; ?>" id="doukounm01_<?php echo $count; ?>" value="<?php echo isset($result['doukounm01']) ? $result['doukounm01'] : ''?>">
</td>
</tr>
</table>
...
<textarea style="height:100px;width:600px;" name="sdn_niyo_<?php echo $count; ?>"><?php echo isset($result['sdn_niyo']) ? $result['sdn_niyo'] : ''?></textarea>
</td>
</tr>
<br>
<tr>
