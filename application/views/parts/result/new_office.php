...
その他<input type="text" style="width:120px;" maxlength="256" name="sntsagyo_<?php echo $count; ?>" id="sntsagyo_<?php echo $count; ?>" value="<?php echo isset($result['sntsagyo']) ? $result['sntsagyo'] : ''?>">
</td>
</tr>
</table>
</td>
...
<td colspan="3">
	...
	<tr>
	<td>
	<textarea style="height:100px; width:600px" name="kekka_<?php echo $count; ?>" id="kekka_<?php echo $count; ?>" value="">
