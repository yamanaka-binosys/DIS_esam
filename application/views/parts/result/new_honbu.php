...
<td></td>
<td>
<input type="hidden" name="aiteskcd_<?php echo $count; ?>" id="aiteskcd_<?php echo $count; ?>" value="<?php echo isset($result['aiteskcd']) ? $result['aiteskcd'] : ''?>" class="required" title="販売店名">
...
<tr><td><input type="text" maxlength="256" style="width: 120px;" name="basyo_<?php echo $count; ?>" id="basyo_<?php echo $count; ?>" value="<?php echo isset($result['basyo']) ? $result['basyo'] : ''?>" /></td></tr>
</table>
</td>
</tr>
</table>
...
<table style="border:1px #000000 solid; margin-left:-2px;">
<tr>
<td>
...
<table style="border:1px #000000 solid; margin-left:-4px;">
<tr>
<td>
...
if(isset($result['seiykuriage'])){
	if($result['seiykuriage'] == 0){
		echo "<input type=\"text\" size=\"10\" class=\"numInputOnly\" title=\"契約金額/半期\" maxlength=\"9\" name=\"seiykuriage_".$count."\" value=\"\"></td>";
	}else{
		echo "<input type=\"text\" size=\"10\" class=\"numInputOnly\" title=\"契約金額/半期\" maxlength=\"9\" name=\"seiykuriage_".$count."\" value=\"".$result['seiykuriage']."\"></td>";
	}
}else{
	echo "<input type=\"text\" size=\"10\" class=\"numInputOnly\" title=\"契約金額/半期\" maxlength=\"9\" name=\"seiykuriage_".$count."\" value=\"\"></td>";
}
...
<textarea style="height:100px; width:600px; margin-left:0px" name="seiykniyo_<?php echo $count; ?>"><?php echo isset($result['seiykniyo']) ? $result['seiykniyo'] : ''?></textarea>
</td>
</tr>
<tr><td></td></tr>
...
<tr>
<td style="padding-left:10px" colspan="3">
<textarea style="height:100px; width:600px; margin-left:0px" name="fseiykniyo_<?php echo $count; ?>"><?php echo isset($result['fseiykniyo']) ? $result['fseiykniyo'] : ''?></textarea>
</td>
</tr>
<tr><td></td></tr>
<tr>
...
<tr>
<td style="padding-left:10px" colspan="3">
<textarea style="height:100px; width:600px; margin-left:0px" name="horyuniyo_<?php echo $count; ?>"><?php echo isset($result['horyuniyo']) ? $result['horyuniyo'] : ''?></textarea>
</td>
</tr>
<tr><td></td></tr>
...
<tr>
<td style="padding-left:10px" colspan="3">
<textarea style="height:100px; width:600px; margin-left:0px" name="sonotaniyo_<?php echo $count; ?>"><?php echo isset($result['sonotaniyo']) ? $result['sonotaniyo'] : ''?></textarea>
</td>
</tr>
</table>
</td>
