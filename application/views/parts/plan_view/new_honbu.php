...
<tr><td><input type="text" maxlength="256" style="width: 120px;" name="basyo_<?php echo $count; ?>" id="basyo_<?php echo $count; ?>" value="<?php echo isset($plan['basyo']) ? $plan['basyo'] : ''?>"  readonly="readonly"></td></tr>
</table>
</td>
</tr>
</table>
...
<tr>
<td colspan="5">
<textarea rows="3" cols="80" name="sdn_yotei_<?php echo $count; ?>" id="sdn_yotei_<?php echo $count; ?>" readonly="readonly"><?php echo isset($plan['sdn_yotei']) ? $plan['sdn_yotei'] : ''?></textarea>
</td>
</tr>
<tr><td></td></tr>
<tr>
