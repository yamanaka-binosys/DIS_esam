...
<input type="button" value="選択" onclick=""></td>
</tr>
<tr>
<td></td>
</tr>
...
<td></td>
<td>
<input type="text" style="width: 200px;"  maxlength="256" name="doukounm01_<?php echo $count; ?>" id="doukounm01_<?php echo $count; ?>" value="<?php echo isset($plan['doukounm01']) ? $plan['doukounm01'] : ''?>" readonly="readonly">
</td>
</tr>
</table>
